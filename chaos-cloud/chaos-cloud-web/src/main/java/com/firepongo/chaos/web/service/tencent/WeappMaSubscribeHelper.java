...
import com.firepongo.chaos.app.tencent.weapp.WeappTemplateData;
 ...
 */
@Component
public class WeappMaSubscribeHelper {
    ...
    public String push(String openid, String templateId, Map<String, WeappTemplateData> m) {
