<template>
  <el-container>
    <el-header>
      <el-container>
        <el-button type="primary" v-on:click="showAddForm=true">增加资源</el-button>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div style="color: #67c23a" v-if="scope.row.isroot=='1'">
              是
            </div>
            <div style="color: #f56c6c" v-if="scope.row.isroot=='0'">
              否
            </div>
          </template>
        </el-table-column>
    ...
    <el-footer>
      <el-dialog width="35%" title="添加资源" :visible.sync="showAddForm">
        <el-form ref="form" :rules="rules" :model="form" label-width="100px"
          ...
          <el-form-item label="是否根节点">
            <el-radio-group v-model="form.isroot" @change="doFormIsroot">
      ...
      <el-dialog width="35%" title="修改资源" :visible.sync="showUpdateForm">
        <el-form ref="updateForm" :rules="rules" :model="updateForm"
          ...
          <el-form-item label="链接" prop="info">
...
<script>
    ...
    export default {
        ...
        mounted() {
            Data.chain([this.listPlatform, this.search])
        },
        methods: {
            search() {
