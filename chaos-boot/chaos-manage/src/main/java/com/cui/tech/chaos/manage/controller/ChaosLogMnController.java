...
public class ChaosLogMnController extends BaseController {
    ...
    public DataResult<MU> add(@RequestBody @Validated ChaosLogData data, BindingResult bindingResult) throws Exception {
        validate(bindingResult);
        return getResult(iChaosLogService.insertModel(data));
    }
